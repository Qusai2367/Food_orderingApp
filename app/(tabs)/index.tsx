...
import CartButton from "@/components/CardBtn";
import cn from "clsx";
                            ...
                            {(pressed) => (
                                <>
                                    ...
                                    <View className={cn("offer-card__info", isEven ? "pl-10" : "pr-10")}>
                                        <Text className="h1-bold text-white leading-light">
                                            {item.title}
                                        </Text>
                    ...
                    <View className="flex-between flex-row w-full my-5">
                        <View className="flex-start">
                            ...
                            <TouchableOpacity className="flex-center flex-row gap-x-1 mt-0.5">
                                <Text className="paragraph-bold text-dark-100">Sudan</Text>
                                <Image source={images.arrowDown} className="size-3" resizeMode="cover" />
                            </TouchableOpacity>
                        </View>
